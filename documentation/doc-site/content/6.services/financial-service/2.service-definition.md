...
- [financial_service/v1/message_financial_service.proto](#financial_service_v1_message_financial_service-proto)
    - [AccountStatements](#financial_service-v1-AccountStatements)
...
- [financial_service/v1/request_response_financial_analytics_service.proto](#financial_service_v1_request_response_financial_analytics_service-proto)
    ...
    - [GetCategoryMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeRequest)
    - [GetCategoryMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeResponse)
...
- [financial_service/v1/request_response_financial_service.proto](#financial_service_v1_request_response_financial_service-proto)
    ...
    - [CreateCreditAccountRequest](#financial_service-v1-CreateCreditAccountRequest)
    - [CreateCreditAccountResponse](#financial_service-v1-CreateCreditAccountResponse)
...
| plaid_account_type | [string](#string) |  |  |
...
| status | [BankAccountStatus](#financial_service-v1-BankAccountStatus) |  | the bank account status |
| statements | [AccountStatements](#financial_service-v1-AccountStatements) | repeated | the set of statements tied to this account |
| type | [BankAccountType](#financial_service-v1-BankAccountType) |  |  |
| plaid_account_type | [string](#string) |  |  |
...
<a name="financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeRequest"></a>

### GetCategoryMetricsFinancialSubProfileOverTimeRequest
financial sub-profile analytics endpoints
...
<a name="financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [CategoryMetricsFinancialSubProfile](#financial_service-v1-CategoryMetricsFinancialSubProfile) | repeated |  |
...
<a name="financial_service-v1-GetExpenseMetricsFinancialSubProfileOverTimeRequest"></a>

### GetExpenseMetricsFinancialSubProfileOverTimeRequest
financial sub-profile analytics endpoints (expense metrics)
...
<a name="financial_service-v1-GetExpenseMetricsFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [ExpenseMetricsFinancialSubProfileMetrics](#financial_service-v1-ExpenseMetricsFinancialSubProfileMetrics) | repeated |  |
...
<a name="financial_service-v1-GetIncomeMetricsFinancialSubProfileOverTimeRequest"></a>

### GetIncomeMetricsFinancialSubProfileOverTimeRequest
...
<a name="financial_service-v1-GetIncomeMetricsFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [IncomeMetricsFinancialSubProfile](#financial_service-v1-IncomeMetricsFinancialSubProfile) | repeated |  |
...
<a name="financial_service-v1-GetLocationMetricsFinancialSubProfileOverTimeRequest"></a>

### GetLocationMetricsFinancialSubProfileOverTimeRequest
...
<a name="financial_service-v1-GetLocationMetricsFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [LocationFinancialSubProfile](#financial_service-v1-LocationFinancialSubProfile) | repeated |  |
...
<a name="financial_service-v1-GetMerchantMetricsFinancialSubProfileOverTimeRequest"></a>

### GetMerchantMetricsFinancialSubProfileOverTimeRequest
...
<a name="financial_service-v1-GetMerchantMetricsFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [MerchantMetricsFinancialSubProfile](#financial_service-v1-MerchantMetricsFinancialSubProfile) | repeated |  |
...
<a name="financial_service-v1-GetPaymentChannelFinancialSubProfileOverTimeRequest"></a>

### GetPaymentChannelFinancialSubProfileOverTimeRequest
...
<a name="financial_service-v1-GetPaymentChannelFinancialSubProfileOverTimeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [PaymentChannelMetricsFinancialSubProfile](#financial_service-v1-PaymentChannelMetricsFinancialSubProfile) | repeated |  |
...
<a name="financial_service-v1-AddNoteToFinancialUserProfileRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| business_account_id | [uint64](#uint64) |  | The business account id Validations: - business_account_id must be greater than 0 |
| note | [SmartNote](#financial_service-v1-SmartNote) |  | The note to add Validations: - cannot be nil hence required |
| user_id | [string](#string) |  | The user id of the user adding the note Validations: - user_id must be greater than 0 |
| profile_type | [FinancialUserProfileType](#financial_service-v1-FinancialUserProfileType) |  |  |
...
<a name="financial_service-v1-AddNoteToFinancialUserProfileResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| business_account | [FinancialUserProfile](#financial_service-v1-FinancialUserProfile) |  | The business account id |
...
<a name="financial_service-v1-AddTransactionsToManuallyLinkedAccountRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| account_id | [uint64](#uint64) |  | The account id. Validations: - account_id must be greater than 0 |
| transactions | [PlaidAccountTransaction](#financial_service-v1-PlaidAccountTransaction) | repeated | The transactions to add. Validations: - cannot be nil hence required - must have at least 1 item and at most 400 items |
| profile_type | [FinancialUserProfileType](#financial_service-v1-FinancialUserProfileType) |  | The financial user profile type. Required field. |
| financial_account_type | [FinancialAccountType](#financial_service-v1-FinancialAccountType) |  | The financial account type. |
| user_id | [string](#string) |  | The user id. Validations: - user_id must have a minimum length of 1 character |
| link_id | [uint64](#uint64) |  |  |
...
<a name="financial_service-v1-AddTransactionsToManuallyLinkedAccountResponse"></a>
...
<a name="financial_service-v1-CreateCreditAccountRequest"></a>

### CreateCreditAccountRequest
CreateCreditAccountRequest: Represents the request object invoked against the financial
service to create a credit account for a given user


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| user_id | [string](#string) |  | The account ID associated with the user Validations: - user_id must be greater than 0 |
| credit_account | [CreditAccount](#financial_service-v1-CreditAccount) |  | The bank account to create Validations: - cannot be nil hence required |
| profile_type | [FinancialUserProfileType](#financial_service-v1-FinancialUserProfileType) |  |  |
| link_id | [uint64](#uint64) |  | The linkId to associate this bank account with |
...
<a name="financial_service-v1-CreateCreditAccountResponse"></a>

### CreateCreditAccountResponse
CreateCreditAccountResponse: Represents the response object returned as a response to
the `create bank account` request


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| credit_account_id | [uint64](#uint64) |  | The bank account id |
...
<a name="financial_service-v1-GetNotesFromFinancialUserProfileRequest"></a>

### GetNotesFromFinancialUserProfileRequest



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| business_account_user_id | [string](#string) |  | The business account id Validations: - business_account_id must be greater than 0 |
| profile_type | [FinancialUserProfileType](#financial_service-v1-FinancialUserProfileType) |  |  |
...
<a name="financial_service-v1-GetNotesFromFinancialUserProfileResponse"></a>
...
<a name="financial_service-v1-GetRecurringTransactionsForUserRequest"></a>

### GetRecurringTransactionsForUserRequest
...
<a name="financial_service-v1-GetRecurringTransactionsForUserResponse"></a>
...
<a name="financial_service-v1-GetSingleRecurringTransactionRequest"></a>

### GetSingleRecurringTransactionRequest
...
<a name="financial_service-v1-GetSingleRecurringTransactionResponse"></a>
...
| user_id | [string](#string) |  | The account ID associated with the user. NOTE: This user_id is the simfiny backend platform wide user id Validations: - user_id must be greater than 0 |
| profile_type | [FinancialUserProfileType](#financial_service-v1-FinancialUserProfileType) |  |  |
| bypass_cache | [bool](#bool) |  | bypass_cache is a flag to bypass the cache and fetch the data from the source this is very valuable when we want to get the latest data from the source |
...
<a name="financial_service-v1-ListRecurringTransactionsForUserAndAccountRequest"></a>

### ListRecurringTransactionsForUserAndAccountRequest
...
<a name="financial_service-v1-ListRecurringTransactionsForUserAndAccountResponse"></a>
...
<a name="financial_service-v1-UpdateSingleTransactionRequest"></a>

### UpdateSingleTransactionRequest
UpdateSingleTransactionRequest is the update transaction request
...
<a name="financial_service-v1-UpdateSingleTransactionResponse"></a>

### UpdateSingleTransactionResponse
UpdateSingleTransactionResponse is the update transaction response
...
| CreateCreditAccount | [CreateCreditAccountRequest](#financial_service-v1-CreateCreditAccountRequest) | [CreateCreditAccountResponse](#financial_service-v1-CreateCreditAccountResponse) | CreateCreditAccount creates a credit account for a given user profile |
...
| GetRecurringTransactionsForUser | [GetRecurringTransactionsForUserRequest](#financial_service-v1-GetRecurringTransactionsForUserRequest) | [GetRecurringTransactionsForUserResponse](#financial_service-v1-GetRecurringTransactionsForUserResponse) | This endpoint enables end users to get recurring transactions |
...
| UpdateSingleTransaction | [UpdateSingleTransactionRequest](#financial_service-v1-UpdateSingleTransactionRequest) | [UpdateSingleTransactionResponse](#financial_service-v1-UpdateSingleTransactionResponse) | updates a transaction |
...
| ListRecurringTransactionsForUserAndAccount | [ListRecurringTransactionsForUserAndAccountRequest](#financial_service-v1-ListRecurringTransactionsForUserAndAccountRequest) | [ListRecurringTransactionsForUserAndAccountResponse](#financial_service-v1-ListRecurringTransactionsForUserAndAccountResponse) | ListRecurringTransactions lists a set of transactions against an account of interest |
| GetSingleRecurringTransaction | [GetSingleRecurringTransactionRequest](#financial_service-v1-GetSingleRecurringTransactionRequest) | [GetSingleRecurringTransactionResponse](#financial_service-v1-GetSingleRecurringTransactionResponse) | GetRecurringTransaction lists a set of transactions against an account of interest |
...
| AddNoteToFinancialUserProfile | [AddNoteToFinancialUserProfileRequest](#financial_service-v1-AddNoteToFinancialUserProfileRequest) | [AddNoteToFinancialUserProfileResponse](#financial_service-v1-AddNoteToFinancialUserProfileResponse) | this is useful for the admin to add notes to customer profiles for business accounts |
| GetNotesFromFinancialUserProfile | [GetNotesFromFinancialUserProfileRequest](#financial_service-v1-GetNotesFromFinancialUserProfileRequest) | [GetNotesFromFinancialUserProfileResponse](#financial_service-v1-GetNotesFromFinancialUserProfileResponse) | this is useful for the admin to update notes to customer profiles for business accounts |
| AddTransactionsToManuallyLinkedAccount | [AddTransactionsToManuallyLinkedAccountRequest](#financial_service-v1-AddTransactionsToManuallyLinkedAccountRequest) | [AddTransactionsToManuallyLinkedAccountResponse](#financial_service-v1-AddTransactionsToManuallyLinkedAccountResponse) | this is useful for the admin to add transactions to manually linked accounts |
| GetCategoryMetricsFinancialSubProfileOverTime | [GetCategoryMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeRequest) | [GetCategoryMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetCategoryMetricsFinancialSubProfileOverTimeResponse) |  |
| GetExpenseMetricsFinancialSubProfileOverTime | [GetExpenseMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetExpenseMetricsFinancialSubProfileOverTimeRequest) | [GetExpenseMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetExpenseMetricsFinancialSubProfileOverTimeResponse) |  |
| GetIncomeMetricsFinancialSubProfileOverTime | [GetIncomeMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetIncomeMetricsFinancialSubProfileOverTimeRequest) | [GetIncomeMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetIncomeMetricsFinancialSubProfileOverTimeResponse) |  |
| GetLocationMetricsFinancialSubProfileOverTime | [GetLocationMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetLocationMetricsFinancialSubProfileOverTimeRequest) | [GetLocationMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetLocationMetricsFinancialSubProfileOverTimeResponse) |  |
| GetMerchantMetricsFinancialSubProfileOverTime | [GetMerchantMetricsFinancialSubProfileOverTimeRequest](#financial_service-v1-GetMerchantMetricsFinancialSubProfileOverTimeRequest) | [GetMerchantMetricsFinancialSubProfileOverTimeResponse](#financial_service-v1-GetMerchantMetricsFinancialSubProfileOverTimeResponse) |  |
| GetPaymentChannelFinancialSubProfileOverTime | [GetPaymentChannelFinancialSubProfileOverTimeRequest](#financial_service-v1-GetPaymentChannelFinancialSubProfileOverTimeRequest) | [GetPaymentChannelFinancialSubProfileOverTimeResponse](#financial_service-v1-GetPaymentChannelFinancialSubProfileOverTimeResponse) |  |
