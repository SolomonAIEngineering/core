...
| start_time | [string](#string) |  | The start of the time range for the transactions (inclusive). |
| end_time | [string](#string) |  | The end of the time range for the transactions (exclusive). |
