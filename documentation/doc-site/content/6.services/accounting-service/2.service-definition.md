...
<a name="accounting_service-v1-GetWorkflowExecutionStatusRequest"></a>

### GetWorkflowExecutionStatusRequest
...
| workflow_run_id | [string](#string) |  | The run id Validations: - run id cannot be empty |
...
<a name="accounting_service-v1-ReadBusinessTransactionsRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| auth_zero_user_id | [string](#string) |  | The ID of the user whose transactions are to be fetched. |
| linked_accounting_account_id | [uint64](#uint64) |  | The ID of the accounting account whose transactions are to be fetched. |
| page_number | [uint64](#uint64) |  | The page number of the paginated results. |
| page_size | [uint64](#uint64) |  | The number of items to be returned per page. |
...
<a name="accounting_service-v1-ReadBusinessTransactionsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| transactions | [BusinessTransaction](#accounting_service-v1-BusinessTransaction) | repeated | The list of transactions for the current page. |
| next_page | [uint64](#uint64) |  | The current page number. |
...
| workflow_id | [string](#string) |  | A string field named &#34;workflow_id&#34; with field number 2. |
| workflow_run_id | [string](#string) |  | A string field named &#34;workflow_run_id&#34; with field number 3. |
...
<a name="accounting_service-v1-GetWorkflowExecutionStatusResponse"></a>
...
| status | [string](#string) |  | The task status |
...
| ReadBusinessTransactions | [ReadBusinessTransactionsRequest](#accounting_service-v1-ReadBusinessTransactionsRequest) | [ReadBusinessTransactionsResponse](#accounting_service-v1-ReadBusinessTransactionsResponse) | ReadBusinessTransactions reads the business transactions for a given a user |
| GetWorkflowExecutionStatus | [GetWorkflowExecutionStatusRequest](#accounting_service-v1-GetWorkflowExecutionStatusRequest) | [GetWorkflowExecutionStatusResponse](#accounting_service-v1-GetWorkflowExecutionStatusResponse) |  |
