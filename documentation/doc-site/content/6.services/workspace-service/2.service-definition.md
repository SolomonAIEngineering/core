...
| UploadFile | [UploadFileRequest](#workspace_service-v1-UploadFileRequest) stream | [UploadFileResponse](#workspace_service-v1-UploadFileResponse) | Allows for uploading a file using multipart form data. consumes: multipart/form-data |
