...
func main() {
	...
	workspaceOutputPath := "../../pkg/generated/workspace_service/dal"
	workspaceModels := getAllWorkspaceModels()
	autogenerateDal(&workspaceOutputPath, workspaceModels)
}
...
func getAllWorkspaceModels() []interface{} {
	models := workspaceServiceProto.GetDatabaseSchemas()
	return models
}
