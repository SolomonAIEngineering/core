...
type UserServiceClient interface {
	...
	// based on the provided user ID. The endpoint for this service is `/api/v2/user-service/user/{user_id}`.
	// The service provides a concise and clear response encapsulated in `GetUserV2Response`.
	// URI - /api/v2/user-service/user/{user_id}
	...
	// URI -/api/v2/user-service/user/username/{username}
	...
	// URI -/api/v2/user-service/user/email/{email}
	...
	// URI - /api/v2/user-service/user/account
	...
	// URI - /api/v2/user-service/user/username/{username}/exists
	...
	// URI - /api/v2/user-service/user/email/{email}/exists
	...
	// URI - /api/v2/user-service/user/verification/{user_id}/{profile_type}
	...
	// URI - /api/v2/user-service/user/webhook/password-reset
	...
	// URI - /api/v2/user-service/user/business/settings/{user_id}
...
func (c *userServiceClient) GetCannyUserSSOToken(ctx context.Context, in *GetCannyUserSSOTokenRequest, opts ...grpc.CallOption) (*GetCannyUserSSOTokenResponse, error) {
	out := new(GetCannyUserSSOTokenResponse)
	err := c.cc.Invoke(ctx, UserService_GetCannyUserSSOToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_GetCannyUserSSOToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCannyUserSSOTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetCannyUserSSOToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetCannyUserSSOToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetCannyUserSSOToken(ctx, req.(*GetCannyUserSSOTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
