...
type ITagsORMDo interface {
	...
	GetByID(id uint64) (result user_servicev1.TagsORM, err error)
	GetByIDs(ids []uint64) (result []user_servicev1.TagsORM, err error)
}
...
//
// {{end}}
func (t tagsORMDo) GetByID(id uint64) (result user_servicev1.TagsORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t tagsORMDo) GetByIDs(ids []uint64) (result []user_servicev1.TagsORM, err error) {
	var params []interface{}
