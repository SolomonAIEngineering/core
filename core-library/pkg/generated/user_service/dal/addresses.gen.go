...
func newAddressORM(db *gorm.DB, opts ...gen.DOOption) addressORM {
	...
	_addressORM.addressORMDo.UseModel(&user_servicev1.AddressORM{})
	...
	_addressORM.Longitude = field.NewString(tableName, "longitude")
	_addressORM.State = field.NewString(tableName, "state")
	_addressORM.Unit = field.NewString(tableName, "unit")
	_addressORM.UserAccountId = field.NewUint64(tableName, "user_account_id")
	_addressORM.Zipcode = field.NewString(tableName, "zipcode")
...
func (a *addressORM) updateTableName(table string) *addressORM {
	...
	a.Unit = field.NewString(table, "unit")
	a.UserAccountId = field.NewUint64(table, "user_account_id")
...
func (a *addressORM) fillFieldMap() {
	...
	a.fieldMap["unit"] = a.Unit
	a.fieldMap["user_account_id"] = a.UserAccountId
...
type IAddressORMDo interface {
	...
	Create(values ...*user_servicev1.AddressORM) error
	CreateInBatches(values []*user_servicev1.AddressORM, batchSize int) error
	Save(values ...*user_servicev1.AddressORM) error
	First() (*user_servicev1.AddressORM, error)
	Take() (*user_servicev1.AddressORM, error)
	Last() (*user_servicev1.AddressORM, error)
	Find() ([]*user_servicev1.AddressORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*user_servicev1.AddressORM, err error)
	FindInBatches(result *[]*user_servicev1.AddressORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*user_servicev1.AddressORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*user_servicev1.AddressORM, error)
	FirstOrCreate() (*user_servicev1.AddressORM, error)
	FindByPage(offset int, limit int) (result []*user_servicev1.AddressORM, count int64, err error)
	...
	GetRecordByID(id int) (result user_servicev1.AddressORM, err error)
	GetRecordByIDs(ids []int) (result []user_servicev1.AddressORM, err error)
	CreateRecord(item user_servicev1.AddressORM) (err error)
	UpdateRecordByID(id int, item user_servicev1.AddressORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []user_servicev1.AddressORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result user_servicev1.AddressORM, err error)
	GetByIDs(ids []uint64) (result []user_servicev1.AddressORM, err error)
}
...
//
// {{end}}
func (a addressORMDo) GetRecordByID(id int) (result user_servicev1.AddressORM, err error) {
...
//
// {{end}}
func (a addressORMDo) GetRecordByIDs(ids []int) (result []user_servicev1.AddressORM, err error) {
	var params []interface{}
...
func (a addressORMDo) CreateRecord(item user_servicev1.AddressORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a addressORMDo) UpdateRecordByID(id int, item user_servicev1.AddressORM) (err error) {
	var params []interface{}
...
func (a addressORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []user_servicev1.AddressORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a addressORMDo) GetByID(id uint64) (result user_servicev1.AddressORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a addressORMDo) GetByIDs(ids []uint64) (result []user_servicev1.AddressORM, err error) {
	var params []interface{}
...
func (a addressORMDo) Create(values ...*user_servicev1.AddressORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a addressORMDo) CreateInBatches(values []*user_servicev1.AddressORM, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a addressORMDo) Save(values ...*user_servicev1.AddressORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a addressORMDo) First() (*user_servicev1.AddressORM, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*user_servicev1.AddressORM), nil
	}
}

func (a addressORMDo) Take() (*user_servicev1.AddressORM, error) {
...
func (a addressORMDo) Last() (*user_servicev1.AddressORM, error) {
...
func (a addressORMDo) Find() ([]*user_servicev1.AddressORM, error) {
	result, err := a.DO.Find()
	return result.([]*user_servicev1.AddressORM), err
}

func (a addressORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*user_servicev1.AddressORM, err error) {
	buf := make([]*user_servicev1.AddressORM, 0, batchSize)
...
func (a addressORMDo) FindInBatches(result *[]*user_servicev1.AddressORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a addressORMDo) FirstOrInit() (*user_servicev1.AddressORM, error) {
...
func (a addressORMDo) FirstOrCreate() (*user_servicev1.AddressORM, error) {
...
func (a addressORMDo) FindByPage(offset int, limit int) (result []*user_servicev1.AddressORM, count int64, err error) {
...
func (a addressORMDo) Delete(models ...*user_servicev1.AddressORM) (result gen.ResultInfo, err error) {
