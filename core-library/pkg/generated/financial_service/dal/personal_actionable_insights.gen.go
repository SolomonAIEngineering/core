...
type IPersonalActionableInsightORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PersonalActionableInsightORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PersonalActionableInsightORM, err error)
}
...
//
// {{end}}
func (p personalActionableInsightORMDo) GetByID(id uint64) (result financial_servicev1.PersonalActionableInsightORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p personalActionableInsightORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PersonalActionableInsightORM, err error) {
	var params []interface{}
