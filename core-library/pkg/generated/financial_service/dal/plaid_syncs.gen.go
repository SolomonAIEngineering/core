...
type IPlaidSyncORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PlaidSyncORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PlaidSyncORM, err error)
}
...
//
// {{end}}
func (p plaidSyncORMDo) GetByID(id uint64) (result financial_servicev1.PlaidSyncORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p plaidSyncORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PlaidSyncORM, err error) {
	var params []interface{}
