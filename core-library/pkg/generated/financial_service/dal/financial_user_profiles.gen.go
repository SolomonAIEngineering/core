	...
	_financialUserProfileORM.Link = financialUserProfileORMHasManyLink{
		...
		BankAccounts: struct {
			...
			RecurringTransactions: struct {
				...
				Notes: struct {
					...
					RelationField: field.NewRelation("Link.BankAccounts.RecurringTransactions.Notes", "financial_servicev1.SmartNoteORM"),
				},
			},
			Statements: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Link.BankAccounts.Statements", "financial_servicev1.AccountStatementsORM"),
			},
			Transactions: struct {
				field.RelationField
				Notes struct {
		...
		CreditAccounts: struct {
			...
			Statements: struct {
				...
				RelationField: field.NewRelation("Link.CreditAccounts.Statements", "financial_servicev1.AccountStatementsORM"),
			},
			Transactions: struct {
				field.RelationField
			}{
		...
		InvestmentAccounts: struct {
			...
			Statements: struct {
				...
				RelationField: field.NewRelation("Link.InvestmentAccounts.Statements", "financial_servicev1.AccountStatementsORM"),
			},
			Transactions: struct {
				field.RelationField
				Notes struct {
				...
				Notes: struct {
					...
					RelationField: field.NewRelation("Link.InvestmentAccounts.Transactions.Notes", "financial_servicev1.SmartNoteORM"),
				},
			},
		},
		MortgageAccounts: struct {
			...
			Statements: struct {
				...
				RelationField: field.NewRelation("Link.MortgageAccounts.Statements", "financial_servicev1.AccountStatementsORM"),
			},
		},
		StudentLoanAccounts: struct {
			...
			Statements: struct {
				...
				RelationField: field.NewRelation("Link.StudentLoanAccounts.Statements", "financial_servicev1.AccountStatementsORM"),
			},
		},
	}
...
type IFinancialUserProfileORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.FinancialUserProfileORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.FinancialUserProfileORM, err error)
}
...
//
// {{end}}
func (f financialUserProfileORMDo) GetByID(id uint64) (result financial_servicev1.FinancialUserProfileORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (f financialUserProfileORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.FinancialUserProfileORM, err error) {
	var params []interface{}
