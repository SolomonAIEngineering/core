...
type IPlaidLinkORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PlaidLinkORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PlaidLinkORM, err error)
}
...
//
// {{end}}
func (p plaidLinkORMDo) GetByID(id uint64) (result financial_servicev1.PlaidLinkORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p plaidLinkORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PlaidLinkORM, err error) {
	var params []interface{}
