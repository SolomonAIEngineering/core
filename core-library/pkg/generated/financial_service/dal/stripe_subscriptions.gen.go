...
type IStripeSubscriptionORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.StripeSubscriptionORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.StripeSubscriptionORM, err error)
}
...
//
// {{end}}
func (s stripeSubscriptionORMDo) GetByID(id uint64) (result financial_servicev1.StripeSubscriptionORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (s stripeSubscriptionORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.StripeSubscriptionORM, err error) {
	var params []interface{}
