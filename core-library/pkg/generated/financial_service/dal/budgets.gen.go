...
type IBudgetORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.BudgetORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.BudgetORM, err error)
}
...
//
// {{end}}
func (b budgetORMDo) GetByID(id uint64) (result financial_servicev1.BudgetORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b budgetORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.BudgetORM, err error) {
	var params []interface{}
