...
type IAprORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.AprORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.AprORM, err error)
}
...
//
// {{end}}
func (a aprORMDo) GetByID(id uint64) (result financial_servicev1.AprORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a aprORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.AprORM, err error) {
	var params []interface{}
