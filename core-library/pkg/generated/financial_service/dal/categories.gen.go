...
func newCategoryORM(db *gorm.DB, opts ...gen.DOOption) categoryORM {
	...
	_categoryORM.categoryORMDo.UseModel(&financial_servicev1.CategoryORM{})
...
type ICategoryORMDo interface {
	...
	Create(values ...*financial_servicev1.CategoryORM) error
	CreateInBatches(values []*financial_servicev1.CategoryORM, batchSize int) error
	Save(values ...*financial_servicev1.CategoryORM) error
	First() (*financial_servicev1.CategoryORM, error)
	Take() (*financial_servicev1.CategoryORM, error)
	Last() (*financial_servicev1.CategoryORM, error)
	Find() ([]*financial_servicev1.CategoryORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CategoryORM, err error)
	FindInBatches(result *[]*financial_servicev1.CategoryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*financial_servicev1.CategoryORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*financial_servicev1.CategoryORM, error)
	FirstOrCreate() (*financial_servicev1.CategoryORM, error)
	FindByPage(offset int, limit int) (result []*financial_servicev1.CategoryORM, count int64, err error)
	...
	GetRecordByID(id int) (result financial_servicev1.CategoryORM, err error)
	GetRecordByIDs(ids []int) (result []financial_servicev1.CategoryORM, err error)
	CreateRecord(item financial_servicev1.CategoryORM) (err error)
	UpdateRecordByID(id int, item financial_servicev1.CategoryORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.CategoryORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result financial_servicev1.CategoryORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.CategoryORM, err error)
}
...
//
// {{end}}
func (c categoryORMDo) GetRecordByID(id int) (result financial_servicev1.CategoryORM, err error) {
...
//
// {{end}}
func (c categoryORMDo) GetRecordByIDs(ids []int) (result []financial_servicev1.CategoryORM, err error) {
	var params []interface{}
...
func (c categoryORMDo) CreateRecord(item financial_servicev1.CategoryORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c categoryORMDo) UpdateRecordByID(id int, item financial_servicev1.CategoryORM) (err error) {
	var params []interface{}
...
func (c categoryORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []financial_servicev1.CategoryORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c categoryORMDo) GetByID(id uint64) (result financial_servicev1.CategoryORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c categoryORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.CategoryORM, err error) {
	var params []interface{}
...
func (c categoryORMDo) Create(values ...*financial_servicev1.CategoryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryORMDo) CreateInBatches(values []*financial_servicev1.CategoryORM, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categoryORMDo) Save(values ...*financial_servicev1.CategoryORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryORMDo) First() (*financial_servicev1.CategoryORM, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*financial_servicev1.CategoryORM), nil
	}
}

func (c categoryORMDo) Take() (*financial_servicev1.CategoryORM, error) {
...
func (c categoryORMDo) Last() (*financial_servicev1.CategoryORM, error) {
...
func (c categoryORMDo) Find() ([]*financial_servicev1.CategoryORM, error) {
	result, err := c.DO.Find()
	return result.([]*financial_servicev1.CategoryORM), err
}

func (c categoryORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*financial_servicev1.CategoryORM, err error) {
	buf := make([]*financial_servicev1.CategoryORM, 0, batchSize)
...
func (c categoryORMDo) FindInBatches(result *[]*financial_servicev1.CategoryORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categoryORMDo) FirstOrInit() (*financial_servicev1.CategoryORM, error) {
...
func (c categoryORMDo) FirstOrCreate() (*financial_servicev1.CategoryORM, error) {
...
func (c categoryORMDo) FindByPage(offset int, limit int) (result []*financial_servicev1.CategoryORM, count int64, err error) {
...
func (c categoryORMDo) Delete(models ...*financial_servicev1.CategoryORM) (result gen.ResultInfo, err error) {
