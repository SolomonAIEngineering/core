...
func (a plaidAccountInvestmentTransactionORMHasManyNotesTx) Find() (result []*financial_servicev1.SmartNoteORM, err error) {
	return result, a.tx.Find(&result)
}

func (a plaidAccountInvestmentTransactionORMHasManyNotesTx) Append(values ...*financial_servicev1.SmartNoteORM) (err error) {
...
func (a plaidAccountInvestmentTransactionORMHasManyNotesTx) Replace(values ...*financial_servicev1.SmartNoteORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a plaidAccountInvestmentTransactionORMHasManyNotesTx) Delete(values ...*financial_servicev1.SmartNoteORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IPlaidAccountInvestmentTransactionORMDo interface {
	...
	GetByID(id uint64) (result financial_servicev1.PlaidAccountInvestmentTransactionORM, err error)
	GetByIDs(ids []uint64) (result []financial_servicev1.PlaidAccountInvestmentTransactionORM, err error)
}
...
//
// {{end}}
func (p plaidAccountInvestmentTransactionORMDo) GetByID(id uint64) (result financial_servicev1.PlaidAccountInvestmentTransactionORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p plaidAccountInvestmentTransactionORMDo) GetByIDs(ids []uint64) (result []financial_servicev1.PlaidAccountInvestmentTransactionORM, err error) {
	var params []interface{}
