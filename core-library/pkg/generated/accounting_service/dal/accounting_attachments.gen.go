...
func newAccountingAttachmentORM(db *gorm.DB, opts ...gen.DOOption) accountingAttachmentORM {
	...
	_accountingAttachmentORM.accountingAttachmentORMDo.UseModel(&accounting_servicev1.AccountingAttachmentORM{})
...
type IAccountingAttachmentORMDo interface {
	...
	Create(values ...*accounting_servicev1.AccountingAttachmentORM) error
	CreateInBatches(values []*accounting_servicev1.AccountingAttachmentORM, batchSize int) error
	Save(values ...*accounting_servicev1.AccountingAttachmentORM) error
	First() (*accounting_servicev1.AccountingAttachmentORM, error)
	Take() (*accounting_servicev1.AccountingAttachmentORM, error)
	Last() (*accounting_servicev1.AccountingAttachmentORM, error)
	Find() ([]*accounting_servicev1.AccountingAttachmentORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.AccountingAttachmentORM, err error)
	FindInBatches(result *[]*accounting_servicev1.AccountingAttachmentORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.AccountingAttachmentORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.AccountingAttachmentORM, error)
	FirstOrCreate() (*accounting_servicev1.AccountingAttachmentORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.AccountingAttachmentORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.AccountingAttachmentORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.AccountingAttachmentORM, err error)
	CreateRecord(item accounting_servicev1.AccountingAttachmentORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.AccountingAttachmentORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.AccountingAttachmentORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.AccountingAttachmentORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.AccountingAttachmentORM, err error)
}
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetRecordByID(id int) (result accounting_servicev1.AccountingAttachmentORM, err error) {
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.AccountingAttachmentORM, err error) {
	var params []interface{}
...
func (a accountingAttachmentORMDo) CreateRecord(item accounting_servicev1.AccountingAttachmentORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a accountingAttachmentORMDo) UpdateRecordByID(id int, item accounting_servicev1.AccountingAttachmentORM) (err error) {
	var params []interface{}
...
func (a accountingAttachmentORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.AccountingAttachmentORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetByID(id uint64) (result accounting_servicev1.AccountingAttachmentORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (a accountingAttachmentORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.AccountingAttachmentORM, err error) {
	var params []interface{}
...
func (a accountingAttachmentORMDo) Create(values ...*accounting_servicev1.AccountingAttachmentORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountingAttachmentORMDo) CreateInBatches(values []*accounting_servicev1.AccountingAttachmentORM, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a accountingAttachmentORMDo) Save(values ...*accounting_servicev1.AccountingAttachmentORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountingAttachmentORMDo) First() (*accounting_servicev1.AccountingAttachmentORM, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.AccountingAttachmentORM), nil
	}
}

func (a accountingAttachmentORMDo) Take() (*accounting_servicev1.AccountingAttachmentORM, error) {
...
func (a accountingAttachmentORMDo) Last() (*accounting_servicev1.AccountingAttachmentORM, error) {
...
func (a accountingAttachmentORMDo) Find() ([]*accounting_servicev1.AccountingAttachmentORM, error) {
	result, err := a.DO.Find()
	return result.([]*accounting_servicev1.AccountingAttachmentORM), err
}

func (a accountingAttachmentORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.AccountingAttachmentORM, err error) {
	buf := make([]*accounting_servicev1.AccountingAttachmentORM, 0, batchSize)
...
func (a accountingAttachmentORMDo) FindInBatches(result *[]*accounting_servicev1.AccountingAttachmentORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a accountingAttachmentORMDo) FirstOrInit() (*accounting_servicev1.AccountingAttachmentORM, error) {
...
func (a accountingAttachmentORMDo) FirstOrCreate() (*accounting_servicev1.AccountingAttachmentORM, error) {
...
func (a accountingAttachmentORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.AccountingAttachmentORM, count int64, err error) {
...
func (a accountingAttachmentORMDo) Delete(models ...*accounting_servicev1.AccountingAttachmentORM) (result gen.ResultInfo, err error) {
