...
func newVendorCreditORM(db *gorm.DB, opts ...gen.DOOption) vendorCreditORM {
	...
	_vendorCreditORM.vendorCreditORMDo.UseModel(&accounting_servicev1.VendorCreditORM{})
	...
	_vendorCreditORM.Lines = vendorCreditORMHasManyLines{
		...
		RelationField: field.NewRelation("Lines", "accounting_servicev1.VendorCreditLineORM"),
	}
...
func (a vendorCreditORMHasManyLines) Model(m *accounting_servicev1.VendorCreditORM) *vendorCreditORMHasManyLinesTx {
...
func (a vendorCreditORMHasManyLinesTx) Find() (result []*accounting_servicev1.VendorCreditLineORM, err error) {
	return result, a.tx.Find(&result)
}

func (a vendorCreditORMHasManyLinesTx) Append(values ...*accounting_servicev1.VendorCreditLineORM) (err error) {
...
func (a vendorCreditORMHasManyLinesTx) Replace(values ...*accounting_servicev1.VendorCreditLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a vendorCreditORMHasManyLinesTx) Delete(values ...*accounting_servicev1.VendorCreditLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IVendorCreditORMDo interface {
	...
	Create(values ...*accounting_servicev1.VendorCreditORM) error
	CreateInBatches(values []*accounting_servicev1.VendorCreditORM, batchSize int) error
	Save(values ...*accounting_servicev1.VendorCreditORM) error
	First() (*accounting_servicev1.VendorCreditORM, error)
	Take() (*accounting_servicev1.VendorCreditORM, error)
	Last() (*accounting_servicev1.VendorCreditORM, error)
	Find() ([]*accounting_servicev1.VendorCreditORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.VendorCreditORM, err error)
	FindInBatches(result *[]*accounting_servicev1.VendorCreditORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.VendorCreditORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.VendorCreditORM, error)
	FirstOrCreate() (*accounting_servicev1.VendorCreditORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.VendorCreditORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.VendorCreditORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.VendorCreditORM, err error)
	CreateRecord(item accounting_servicev1.VendorCreditORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.VendorCreditORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.VendorCreditORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.VendorCreditORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.VendorCreditORM, err error)
}
...
//
// {{end}}
func (v vendorCreditORMDo) GetRecordByID(id int) (result accounting_servicev1.VendorCreditORM, err error) {
...
//
// {{end}}
func (v vendorCreditORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.VendorCreditORM, err error) {
	var params []interface{}
...
func (v vendorCreditORMDo) CreateRecord(item accounting_servicev1.VendorCreditORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (v vendorCreditORMDo) UpdateRecordByID(id int, item accounting_servicev1.VendorCreditORM) (err error) {
	var params []interface{}
...
func (v vendorCreditORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.VendorCreditORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (v vendorCreditORMDo) GetByID(id uint64) (result accounting_servicev1.VendorCreditORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (v vendorCreditORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.VendorCreditORM, err error) {
	var params []interface{}
...
func (v vendorCreditORMDo) Create(values ...*accounting_servicev1.VendorCreditORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (v vendorCreditORMDo) CreateInBatches(values []*accounting_servicev1.VendorCreditORM, batchSize int) error {
	return v.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (v vendorCreditORMDo) Save(values ...*accounting_servicev1.VendorCreditORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (v vendorCreditORMDo) First() (*accounting_servicev1.VendorCreditORM, error) {
	if result, err := v.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.VendorCreditORM), nil
	}
}

func (v vendorCreditORMDo) Take() (*accounting_servicev1.VendorCreditORM, error) {
...
func (v vendorCreditORMDo) Last() (*accounting_servicev1.VendorCreditORM, error) {
...
func (v vendorCreditORMDo) Find() ([]*accounting_servicev1.VendorCreditORM, error) {
	result, err := v.DO.Find()
	return result.([]*accounting_servicev1.VendorCreditORM), err
}

func (v vendorCreditORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.VendorCreditORM, err error) {
	buf := make([]*accounting_servicev1.VendorCreditORM, 0, batchSize)
...
func (v vendorCreditORMDo) FindInBatches(result *[]*accounting_servicev1.VendorCreditORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (v vendorCreditORMDo) FirstOrInit() (*accounting_servicev1.VendorCreditORM, error) {
...
func (v vendorCreditORMDo) FirstOrCreate() (*accounting_servicev1.VendorCreditORM, error) {
...
func (v vendorCreditORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.VendorCreditORM, count int64, err error) {
...
func (v vendorCreditORMDo) Delete(models ...*accounting_servicev1.VendorCreditORM) (result gen.ResultInfo, err error) {
