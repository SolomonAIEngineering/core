...
func newPurchaseOrderLineItemORM(db *gorm.DB, opts ...gen.DOOption) purchaseOrderLineItemORM {
	...
	_purchaseOrderLineItemORM.purchaseOrderLineItemORMDo.UseModel(&accounting_servicev1.PurchaseOrderLineItemORM{})
...
type IPurchaseOrderLineItemORMDo interface {
	...
	Create(values ...*accounting_servicev1.PurchaseOrderLineItemORM) error
	CreateInBatches(values []*accounting_servicev1.PurchaseOrderLineItemORM, batchSize int) error
	Save(values ...*accounting_servicev1.PurchaseOrderLineItemORM) error
	First() (*accounting_servicev1.PurchaseOrderLineItemORM, error)
	Take() (*accounting_servicev1.PurchaseOrderLineItemORM, error)
	Last() (*accounting_servicev1.PurchaseOrderLineItemORM, error)
	Find() ([]*accounting_servicev1.PurchaseOrderLineItemORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.PurchaseOrderLineItemORM, err error)
	FindInBatches(result *[]*accounting_servicev1.PurchaseOrderLineItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.PurchaseOrderLineItemORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.PurchaseOrderLineItemORM, error)
	FirstOrCreate() (*accounting_servicev1.PurchaseOrderLineItemORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.PurchaseOrderLineItemORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.PurchaseOrderLineItemORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error)
	CreateRecord(item accounting_servicev1.PurchaseOrderLineItemORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.PurchaseOrderLineItemORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.PurchaseOrderLineItemORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error)
}
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetRecordByID(id int) (result accounting_servicev1.PurchaseOrderLineItemORM, err error) {
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error) {
	var params []interface{}
...
func (p purchaseOrderLineItemORMDo) CreateRecord(item accounting_servicev1.PurchaseOrderLineItemORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) UpdateRecordByID(id int, item accounting_servicev1.PurchaseOrderLineItemORM) (err error) {
	var params []interface{}
...
func (p purchaseOrderLineItemORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetByID(id uint64) (result accounting_servicev1.PurchaseOrderLineItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (p purchaseOrderLineItemORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.PurchaseOrderLineItemORM, err error) {
	var params []interface{}
...
func (p purchaseOrderLineItemORMDo) Create(values ...*accounting_servicev1.PurchaseOrderLineItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (p purchaseOrderLineItemORMDo) CreateInBatches(values []*accounting_servicev1.PurchaseOrderLineItemORM, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p purchaseOrderLineItemORMDo) Save(values ...*accounting_servicev1.PurchaseOrderLineItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (p purchaseOrderLineItemORMDo) First() (*accounting_servicev1.PurchaseOrderLineItemORM, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.PurchaseOrderLineItemORM), nil
	}
}

func (p purchaseOrderLineItemORMDo) Take() (*accounting_servicev1.PurchaseOrderLineItemORM, error) {
...
func (p purchaseOrderLineItemORMDo) Last() (*accounting_servicev1.PurchaseOrderLineItemORM, error) {
...
func (p purchaseOrderLineItemORMDo) Find() ([]*accounting_servicev1.PurchaseOrderLineItemORM, error) {
	result, err := p.DO.Find()
	return result.([]*accounting_servicev1.PurchaseOrderLineItemORM), err
}

func (p purchaseOrderLineItemORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.PurchaseOrderLineItemORM, err error) {
	buf := make([]*accounting_servicev1.PurchaseOrderLineItemORM, 0, batchSize)
...
func (p purchaseOrderLineItemORMDo) FindInBatches(result *[]*accounting_servicev1.PurchaseOrderLineItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p purchaseOrderLineItemORMDo) FirstOrInit() (*accounting_servicev1.PurchaseOrderLineItemORM, error) {
...
func (p purchaseOrderLineItemORMDo) FirstOrCreate() (*accounting_servicev1.PurchaseOrderLineItemORM, error) {
...
func (p purchaseOrderLineItemORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.PurchaseOrderLineItemORM, count int64, err error) {
...
func (p purchaseOrderLineItemORMDo) Delete(models ...*accounting_servicev1.PurchaseOrderLineItemORM) (result gen.ResultInfo, err error) {
