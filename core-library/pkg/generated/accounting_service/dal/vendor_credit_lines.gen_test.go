...
func init() {
	InitializeDB()
	err := db.AutoMigrate(&accounting_servicev1.VendorCreditLineORM{})
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&accounting_servicev1.VendorCreditLineORM{}) fail: %s", err)
	}
}
...
func Test_vendorCreditLineORMQuery(t *testing.T) {
	...
	err = _do.Create(&accounting_servicev1.VendorCreditLineORM{})
	if err != nil {
		t.Error("create item in table <vendor_credit_lines> fail:", err)
	}

	err = _do.Save(&accounting_servicev1.VendorCreditLineORM{})
	if err != nil {
		t.Error("create item in table <vendor_credit_lines> fail:", err)
	}

	err = _do.CreateInBatches([]*accounting_servicev1.VendorCreditLineORM{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <vendor_credit_lines> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*accounting_servicev1.VendorCreditLineORM{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&accounting_servicev1.VendorCreditLineORM{}, 0, 1)
	if err != nil {
...
func Test_vendorCreditLineORM_CreateRecord(t *testing.T) {
	...
	for i, tt := range VendorCreditLineORMCreateRecordTestCase {
		t.Run("CreateRecord_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.CreateRecord(tt.Input.Args[0].(accounting_servicev1.VendorCreditLineORM))
...
func Test_vendorCreditLineORM_UpdateRecordByID(t *testing.T) {
	...
	for i, tt := range VendorCreditLineORMUpdateRecordByIDTestCase {
		t.Run("UpdateRecordByID_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.UpdateRecordByID(tt.Input.Args[0].(int), tt.Input.Args[1].(accounting_servicev1.VendorCreditLineORM))
