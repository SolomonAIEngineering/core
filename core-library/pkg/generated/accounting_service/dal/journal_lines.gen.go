...
func newJournalLineORM(db *gorm.DB, opts ...gen.DOOption) journalLineORM {
	...
	_journalLineORM.journalLineORMDo.UseModel(&accounting_servicev1.JournalLineORM{})
...
type IJournalLineORMDo interface {
	...
	Create(values ...*accounting_servicev1.JournalLineORM) error
	CreateInBatches(values []*accounting_servicev1.JournalLineORM, batchSize int) error
	Save(values ...*accounting_servicev1.JournalLineORM) error
	First() (*accounting_servicev1.JournalLineORM, error)
	Take() (*accounting_servicev1.JournalLineORM, error)
	Last() (*accounting_servicev1.JournalLineORM, error)
	Find() ([]*accounting_servicev1.JournalLineORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.JournalLineORM, err error)
	FindInBatches(result *[]*accounting_servicev1.JournalLineORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.JournalLineORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.JournalLineORM, error)
	FirstOrCreate() (*accounting_servicev1.JournalLineORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.JournalLineORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.JournalLineORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.JournalLineORM, err error)
	CreateRecord(item accounting_servicev1.JournalLineORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.JournalLineORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.JournalLineORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.JournalLineORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.JournalLineORM, err error)
}
...
//
// {{end}}
func (j journalLineORMDo) GetRecordByID(id int) (result accounting_servicev1.JournalLineORM, err error) {
...
//
// {{end}}
func (j journalLineORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.JournalLineORM, err error) {
	var params []interface{}
...
func (j journalLineORMDo) CreateRecord(item accounting_servicev1.JournalLineORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (j journalLineORMDo) UpdateRecordByID(id int, item accounting_servicev1.JournalLineORM) (err error) {
	var params []interface{}
...
func (j journalLineORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.JournalLineORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (j journalLineORMDo) GetByID(id uint64) (result accounting_servicev1.JournalLineORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (j journalLineORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.JournalLineORM, err error) {
	var params []interface{}
...
func (j journalLineORMDo) Create(values ...*accounting_servicev1.JournalLineORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (j journalLineORMDo) CreateInBatches(values []*accounting_servicev1.JournalLineORM, batchSize int) error {
	return j.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (j journalLineORMDo) Save(values ...*accounting_servicev1.JournalLineORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (j journalLineORMDo) First() (*accounting_servicev1.JournalLineORM, error) {
	if result, err := j.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.JournalLineORM), nil
	}
}

func (j journalLineORMDo) Take() (*accounting_servicev1.JournalLineORM, error) {
...
func (j journalLineORMDo) Last() (*accounting_servicev1.JournalLineORM, error) {
...
func (j journalLineORMDo) Find() ([]*accounting_servicev1.JournalLineORM, error) {
	result, err := j.DO.Find()
	return result.([]*accounting_servicev1.JournalLineORM), err
}

func (j journalLineORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.JournalLineORM, err error) {
	buf := make([]*accounting_servicev1.JournalLineORM, 0, batchSize)
...
func (j journalLineORMDo) FindInBatches(result *[]*accounting_servicev1.JournalLineORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (j journalLineORMDo) FirstOrInit() (*accounting_servicev1.JournalLineORM, error) {
...
func (j journalLineORMDo) FirstOrCreate() (*accounting_servicev1.JournalLineORM, error) {
...
func (j journalLineORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.JournalLineORM, count int64, err error) {
...
func (j journalLineORMDo) Delete(models ...*accounting_servicev1.JournalLineORM) (result gen.ResultInfo, err error) {
