...
func newTransactionLineItemORM(db *gorm.DB, opts ...gen.DOOption) transactionLineItemORM {
	...
	_transactionLineItemORM.transactionLineItemORMDo.UseModel(&accounting_servicev1.TransactionLineItemORM{})
...
type ITransactionLineItemORMDo interface {
	...
	Create(values ...*accounting_servicev1.TransactionLineItemORM) error
	CreateInBatches(values []*accounting_servicev1.TransactionLineItemORM, batchSize int) error
	Save(values ...*accounting_servicev1.TransactionLineItemORM) error
	First() (*accounting_servicev1.TransactionLineItemORM, error)
	Take() (*accounting_servicev1.TransactionLineItemORM, error)
	Last() (*accounting_servicev1.TransactionLineItemORM, error)
	Find() ([]*accounting_servicev1.TransactionLineItemORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.TransactionLineItemORM, err error)
	FindInBatches(result *[]*accounting_servicev1.TransactionLineItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.TransactionLineItemORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.TransactionLineItemORM, error)
	FirstOrCreate() (*accounting_servicev1.TransactionLineItemORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.TransactionLineItemORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.TransactionLineItemORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.TransactionLineItemORM, err error)
	CreateRecord(item accounting_servicev1.TransactionLineItemORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.TransactionLineItemORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.TransactionLineItemORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.TransactionLineItemORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.TransactionLineItemORM, err error)
}
...
//
// {{end}}
func (t transactionLineItemORMDo) GetRecordByID(id int) (result accounting_servicev1.TransactionLineItemORM, err error) {
...
//
// {{end}}
func (t transactionLineItemORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.TransactionLineItemORM, err error) {
	var params []interface{}
...
func (t transactionLineItemORMDo) CreateRecord(item accounting_servicev1.TransactionLineItemORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t transactionLineItemORMDo) UpdateRecordByID(id int, item accounting_servicev1.TransactionLineItemORM) (err error) {
	var params []interface{}
...
func (t transactionLineItemORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.TransactionLineItemORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (t transactionLineItemORMDo) GetByID(id uint64) (result accounting_servicev1.TransactionLineItemORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (t transactionLineItemORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.TransactionLineItemORM, err error) {
	var params []interface{}
...
func (t transactionLineItemORMDo) Create(values ...*accounting_servicev1.TransactionLineItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionLineItemORMDo) CreateInBatches(values []*accounting_servicev1.TransactionLineItemORM, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t transactionLineItemORMDo) Save(values ...*accounting_servicev1.TransactionLineItemORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionLineItemORMDo) First() (*accounting_servicev1.TransactionLineItemORM, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.TransactionLineItemORM), nil
	}
}

func (t transactionLineItemORMDo) Take() (*accounting_servicev1.TransactionLineItemORM, error) {
...
func (t transactionLineItemORMDo) Last() (*accounting_servicev1.TransactionLineItemORM, error) {
...
func (t transactionLineItemORMDo) Find() ([]*accounting_servicev1.TransactionLineItemORM, error) {
	result, err := t.DO.Find()
	return result.([]*accounting_servicev1.TransactionLineItemORM), err
}

func (t transactionLineItemORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.TransactionLineItemORM, err error) {
	buf := make([]*accounting_servicev1.TransactionLineItemORM, 0, batchSize)
...
func (t transactionLineItemORMDo) FindInBatches(result *[]*accounting_servicev1.TransactionLineItemORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t transactionLineItemORMDo) FirstOrInit() (*accounting_servicev1.TransactionLineItemORM, error) {
...
func (t transactionLineItemORMDo) FirstOrCreate() (*accounting_servicev1.TransactionLineItemORM, error) {
...
func (t transactionLineItemORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.TransactionLineItemORM, count int64, err error) {
...
func (t transactionLineItemORMDo) Delete(models ...*accounting_servicev1.TransactionLineItemORM) (result gen.ResultInfo, err error) {
