...
func newCompanyInfoORM(db *gorm.DB, opts ...gen.DOOption) companyInfoORM {
	...
	_companyInfoORM.companyInfoORMDo.UseModel(&accounting_servicev1.CompanyInfoORM{})
	...
	_companyInfoORM.Addresses = companyInfoORMHasManyAddresses{
		...
		RelationField: field.NewRelation("Addresses", "accounting_servicev1.CompanyAddressORM"),
	}
...
func (a companyInfoORMHasManyAddresses) Model(m *accounting_servicev1.CompanyInfoORM) *companyInfoORMHasManyAddressesTx {
...
func (a companyInfoORMHasManyAddressesTx) Find() (result []*accounting_servicev1.CompanyAddressORM, err error) {
	return result, a.tx.Find(&result)
}

func (a companyInfoORMHasManyAddressesTx) Append(values ...*accounting_servicev1.CompanyAddressORM) (err error) {
...
func (a companyInfoORMHasManyAddressesTx) Replace(values ...*accounting_servicev1.CompanyAddressORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a companyInfoORMHasManyAddressesTx) Delete(values ...*accounting_servicev1.CompanyAddressORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ICompanyInfoORMDo interface {
	...
	Create(values ...*accounting_servicev1.CompanyInfoORM) error
	CreateInBatches(values []*accounting_servicev1.CompanyInfoORM, batchSize int) error
	Save(values ...*accounting_servicev1.CompanyInfoORM) error
	First() (*accounting_servicev1.CompanyInfoORM, error)
	Take() (*accounting_servicev1.CompanyInfoORM, error)
	Last() (*accounting_servicev1.CompanyInfoORM, error)
	Find() ([]*accounting_servicev1.CompanyInfoORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.CompanyInfoORM, err error)
	FindInBatches(result *[]*accounting_servicev1.CompanyInfoORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.CompanyInfoORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.CompanyInfoORM, error)
	FirstOrCreate() (*accounting_servicev1.CompanyInfoORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.CompanyInfoORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.CompanyInfoORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.CompanyInfoORM, err error)
	CreateRecord(item accounting_servicev1.CompanyInfoORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.CompanyInfoORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.CompanyInfoORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.CompanyInfoORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.CompanyInfoORM, err error)
}
...
//
// {{end}}
func (c companyInfoORMDo) GetRecordByID(id int) (result accounting_servicev1.CompanyInfoORM, err error) {
...
//
// {{end}}
func (c companyInfoORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.CompanyInfoORM, err error) {
	var params []interface{}
...
func (c companyInfoORMDo) CreateRecord(item accounting_servicev1.CompanyInfoORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c companyInfoORMDo) UpdateRecordByID(id int, item accounting_servicev1.CompanyInfoORM) (err error) {
	var params []interface{}
...
func (c companyInfoORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.CompanyInfoORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (c companyInfoORMDo) GetByID(id uint64) (result accounting_servicev1.CompanyInfoORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (c companyInfoORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.CompanyInfoORM, err error) {
	var params []interface{}
...
func (c companyInfoORMDo) Create(values ...*accounting_servicev1.CompanyInfoORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c companyInfoORMDo) CreateInBatches(values []*accounting_servicev1.CompanyInfoORM, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c companyInfoORMDo) Save(values ...*accounting_servicev1.CompanyInfoORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (c companyInfoORMDo) First() (*accounting_servicev1.CompanyInfoORM, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.CompanyInfoORM), nil
	}
}

func (c companyInfoORMDo) Take() (*accounting_servicev1.CompanyInfoORM, error) {
...
func (c companyInfoORMDo) Last() (*accounting_servicev1.CompanyInfoORM, error) {
...
func (c companyInfoORMDo) Find() ([]*accounting_servicev1.CompanyInfoORM, error) {
	result, err := c.DO.Find()
	return result.([]*accounting_servicev1.CompanyInfoORM), err
}

func (c companyInfoORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.CompanyInfoORM, err error) {
	buf := make([]*accounting_servicev1.CompanyInfoORM, 0, batchSize)
...
func (c companyInfoORMDo) FindInBatches(result *[]*accounting_servicev1.CompanyInfoORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c companyInfoORMDo) FirstOrInit() (*accounting_servicev1.CompanyInfoORM, error) {
...
func (c companyInfoORMDo) FirstOrCreate() (*accounting_servicev1.CompanyInfoORM, error) {
...
func (c companyInfoORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.CompanyInfoORM, count int64, err error) {
...
func (c companyInfoORMDo) Delete(models ...*accounting_servicev1.CompanyInfoORM) (result gen.ResultInfo, err error) {
