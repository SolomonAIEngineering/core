...
func newBusinessTransactionORM(db *gorm.DB, opts ...gen.DOOption) businessTransactionORM {
	...
	_businessTransactionORM.businessTransactionORMDo.UseModel(&accounting_servicev1.BusinessTransactionORM{})
	...
	_businessTransactionORM.LineItems = businessTransactionORMHasManyLineItems{
		...
		RelationField: field.NewRelation("LineItems", "accounting_servicev1.TransactionLineItemORM"),
	}
...
func (a businessTransactionORMHasManyLineItems) Model(m *accounting_servicev1.BusinessTransactionORM) *businessTransactionORMHasManyLineItemsTx {
...
func (a businessTransactionORMHasManyLineItemsTx) Find() (result []*accounting_servicev1.TransactionLineItemORM, err error) {
	return result, a.tx.Find(&result)
}

func (a businessTransactionORMHasManyLineItemsTx) Append(values ...*accounting_servicev1.TransactionLineItemORM) (err error) {
...
func (a businessTransactionORMHasManyLineItemsTx) Replace(values ...*accounting_servicev1.TransactionLineItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a businessTransactionORMHasManyLineItemsTx) Delete(values ...*accounting_servicev1.TransactionLineItemORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IBusinessTransactionORMDo interface {
	...
	Create(values ...*accounting_servicev1.BusinessTransactionORM) error
	CreateInBatches(values []*accounting_servicev1.BusinessTransactionORM, batchSize int) error
	Save(values ...*accounting_servicev1.BusinessTransactionORM) error
	First() (*accounting_servicev1.BusinessTransactionORM, error)
	Take() (*accounting_servicev1.BusinessTransactionORM, error)
	Last() (*accounting_servicev1.BusinessTransactionORM, error)
	Find() ([]*accounting_servicev1.BusinessTransactionORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.BusinessTransactionORM, err error)
	FindInBatches(result *[]*accounting_servicev1.BusinessTransactionORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.BusinessTransactionORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.BusinessTransactionORM, error)
	FirstOrCreate() (*accounting_servicev1.BusinessTransactionORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.BusinessTransactionORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.BusinessTransactionORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.BusinessTransactionORM, err error)
	CreateRecord(item accounting_servicev1.BusinessTransactionORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.BusinessTransactionORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.BusinessTransactionORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.BusinessTransactionORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.BusinessTransactionORM, err error)
}
...
//
// {{end}}
func (b businessTransactionORMDo) GetRecordByID(id int) (result accounting_servicev1.BusinessTransactionORM, err error) {
...
//
// {{end}}
func (b businessTransactionORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.BusinessTransactionORM, err error) {
	var params []interface{}
...
func (b businessTransactionORMDo) CreateRecord(item accounting_servicev1.BusinessTransactionORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (b businessTransactionORMDo) UpdateRecordByID(id int, item accounting_servicev1.BusinessTransactionORM) (err error) {
	var params []interface{}
...
func (b businessTransactionORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.BusinessTransactionORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (b businessTransactionORMDo) GetByID(id uint64) (result accounting_servicev1.BusinessTransactionORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b businessTransactionORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.BusinessTransactionORM, err error) {
	var params []interface{}
...
func (b businessTransactionORMDo) Create(values ...*accounting_servicev1.BusinessTransactionORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (b businessTransactionORMDo) CreateInBatches(values []*accounting_servicev1.BusinessTransactionORM, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b businessTransactionORMDo) Save(values ...*accounting_servicev1.BusinessTransactionORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (b businessTransactionORMDo) First() (*accounting_servicev1.BusinessTransactionORM, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.BusinessTransactionORM), nil
	}
}

func (b businessTransactionORMDo) Take() (*accounting_servicev1.BusinessTransactionORM, error) {
...
func (b businessTransactionORMDo) Last() (*accounting_servicev1.BusinessTransactionORM, error) {
...
func (b businessTransactionORMDo) Find() ([]*accounting_servicev1.BusinessTransactionORM, error) {
	result, err := b.DO.Find()
	return result.([]*accounting_servicev1.BusinessTransactionORM), err
}

func (b businessTransactionORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.BusinessTransactionORM, err error) {
	buf := make([]*accounting_servicev1.BusinessTransactionORM, 0, batchSize)
...
func (b businessTransactionORMDo) FindInBatches(result *[]*accounting_servicev1.BusinessTransactionORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b businessTransactionORMDo) FirstOrInit() (*accounting_servicev1.BusinessTransactionORM, error) {
...
func (b businessTransactionORMDo) FirstOrCreate() (*accounting_servicev1.BusinessTransactionORM, error) {
...
func (b businessTransactionORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.BusinessTransactionORM, count int64, err error) {
...
func (b businessTransactionORMDo) Delete(models ...*accounting_servicev1.BusinessTransactionORM) (result gen.ResultInfo, err error) {
