...
func newExpenseORM(db *gorm.DB, opts ...gen.DOOption) expenseORM {
	...
	_expenseORM.expenseORMDo.UseModel(&accounting_servicev1.ExpenseORM{})
	...
	_expenseORM.Lines = expenseORMHasManyLines{
		...
		RelationField: field.NewRelation("Lines", "accounting_servicev1.ExpenseLineORM"),
	}
...
func (a expenseORMHasManyLines) Model(m *accounting_servicev1.ExpenseORM) *expenseORMHasManyLinesTx {
	return &expenseORMHasManyLinesTx{a.db.Model(m).Association(a.Name())}
}

type expenseORMHasManyLinesTx struct{ tx *gorm.Association }

func (a expenseORMHasManyLinesTx) Find() (result []*accounting_servicev1.ExpenseLineORM, err error) {
	return result, a.tx.Find(&result)
}

func (a expenseORMHasManyLinesTx) Append(values ...*accounting_servicev1.ExpenseLineORM) (err error) {
...
func (a expenseORMHasManyLinesTx) Replace(values ...*accounting_servicev1.ExpenseLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a expenseORMHasManyLinesTx) Delete(values ...*accounting_servicev1.ExpenseLineORM) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IExpenseORMDo interface {
	...
	Create(values ...*accounting_servicev1.ExpenseORM) error
	CreateInBatches(values []*accounting_servicev1.ExpenseORM, batchSize int) error
	Save(values ...*accounting_servicev1.ExpenseORM) error
	First() (*accounting_servicev1.ExpenseORM, error)
	Take() (*accounting_servicev1.ExpenseORM, error)
	Last() (*accounting_servicev1.ExpenseORM, error)
	Find() ([]*accounting_servicev1.ExpenseORM, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.ExpenseORM, err error)
	FindInBatches(result *[]*accounting_servicev1.ExpenseORM, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*accounting_servicev1.ExpenseORM) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*accounting_servicev1.ExpenseORM, error)
	FirstOrCreate() (*accounting_servicev1.ExpenseORM, error)
	FindByPage(offset int, limit int) (result []*accounting_servicev1.ExpenseORM, count int64, err error)
	...
	GetRecordByID(id int) (result accounting_servicev1.ExpenseORM, err error)
	GetRecordByIDs(ids []int) (result []accounting_servicev1.ExpenseORM, err error)
	CreateRecord(item accounting_servicev1.ExpenseORM) (err error)
	UpdateRecordByID(id int, item accounting_servicev1.ExpenseORM) (err error)
	DeleteRecordByID(id int) (err error)
	GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.ExpenseORM, err error)
	CountAll() (result int, err error)
	GetByID(id uint64) (result accounting_servicev1.ExpenseORM, err error)
	GetByIDs(ids []uint64) (result []accounting_servicev1.ExpenseORM, err error)
}
...
//
// {{end}}
func (e expenseORMDo) GetRecordByID(id int) (result accounting_servicev1.ExpenseORM, err error) {
...
//
// {{end}}
func (e expenseORMDo) GetRecordByIDs(ids []int) (result []accounting_servicev1.ExpenseORM, err error) {
	var params []interface{}
...
func (e expenseORMDo) CreateRecord(item accounting_servicev1.ExpenseORM) (err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (e expenseORMDo) UpdateRecordByID(id int, item accounting_servicev1.ExpenseORM) (err error) {
	var params []interface{}
...
func (e expenseORMDo) GetAllRecords(orderColumn string, limit int, offset int) (result []accounting_servicev1.ExpenseORM, err error) {
	var generateSQL strings.Builder
...
//
// {{end}}
func (e expenseORMDo) GetByID(id uint64) (result accounting_servicev1.ExpenseORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (e expenseORMDo) GetByIDs(ids []uint64) (result []accounting_servicev1.ExpenseORM, err error) {
	var params []interface{}
...
func (e expenseORMDo) Create(values ...*accounting_servicev1.ExpenseORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (e expenseORMDo) CreateInBatches(values []*accounting_servicev1.ExpenseORM, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e expenseORMDo) Save(values ...*accounting_servicev1.ExpenseORM) error {
	if len(values) == 0 {
		return nil
	}
...
func (e expenseORMDo) First() (*accounting_servicev1.ExpenseORM, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*accounting_servicev1.ExpenseORM), nil
	}
}

func (e expenseORMDo) Take() (*accounting_servicev1.ExpenseORM, error) {
...
func (e expenseORMDo) Last() (*accounting_servicev1.ExpenseORM, error) {
...
func (e expenseORMDo) Find() ([]*accounting_servicev1.ExpenseORM, error) {
	result, err := e.DO.Find()
	return result.([]*accounting_servicev1.ExpenseORM), err
}

func (e expenseORMDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*accounting_servicev1.ExpenseORM, err error) {
	buf := make([]*accounting_servicev1.ExpenseORM, 0, batchSize)
...
func (e expenseORMDo) FindInBatches(result *[]*accounting_servicev1.ExpenseORM, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e expenseORMDo) FirstOrInit() (*accounting_servicev1.ExpenseORM, error) {
...
func (e expenseORMDo) FirstOrCreate() (*accounting_servicev1.ExpenseORM, error) {
...
func (e expenseORMDo) FindByPage(offset int, limit int) (result []*accounting_servicev1.ExpenseORM, count int64, err error) {
...
func (e expenseORMDo) Delete(models ...*accounting_servicev1.ExpenseORM) (result gen.ResultInfo, err error) {
