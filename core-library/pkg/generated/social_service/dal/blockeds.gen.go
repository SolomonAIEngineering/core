...
type IBlockedORMDo interface {
	...
	GetByID(id uint64) (result social_servicev2.BlockedORM, err error)
	GetByIDs(ids []uint64) (result []social_servicev2.BlockedORM, err error)
}
...
//
// {{end}}
func (b blockedORMDo) GetByID(id uint64) (result social_servicev2.BlockedORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (b blockedORMDo) GetByIDs(ids []uint64) (result []social_servicev2.BlockedORM, err error) {
	var params []interface{}
