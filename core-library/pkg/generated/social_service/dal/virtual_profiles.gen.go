...
type IVirtualProfileORMDo interface {
	...
	GetByID(id uint64) (result social_servicev2.VirtualProfileORM, err error)
	GetByIDs(ids []uint64) (result []social_servicev2.VirtualProfileORM, err error)
}
...
//
// {{end}}
func (v virtualProfileORMDo) GetByID(id uint64) (result social_servicev2.VirtualProfileORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (v virtualProfileORMDo) GetByIDs(ids []uint64) (result []social_servicev2.VirtualProfileORM, err error) {
	var params []interface{}
