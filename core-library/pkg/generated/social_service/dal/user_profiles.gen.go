...
type IUserProfileORMDo interface {
	...
	GetByID(id uint64) (result social_servicev2.UserProfileORM, err error)
	GetByIDs(ids []uint64) (result []social_servicev2.UserProfileORM, err error)
}
...
//
// {{end}}
func (u userProfileORMDo) GetByID(id uint64) (result social_servicev2.UserProfileORM, err error) {
	var params []interface{}
...
//
// {{end}}
func (u userProfileORMDo) GetByIDs(ids []uint64) (result []social_servicev2.UserProfileORM, err error) {
	var params []interface{}
