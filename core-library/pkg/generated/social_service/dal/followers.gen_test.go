...
var FollowerORMGetByIDTestCase = []TestCase{}

func Test_followerORM_GetByID(t *testing.T) {
	followerORM := newFollowerORM(db)
	do := followerORM.WithContext(context.Background()).Debug()

	for i, tt := range FollowerORMGetByIDTestCase {
...
var FollowerORMGetByIDsTestCase = []TestCase{}

func Test_followerORM_GetByIDs(t *testing.T) {
	followerORM := newFollowerORM(db)
	do := followerORM.WithContext(context.Background()).Debug()

	for i, tt := range FollowerORMGetByIDsTestCase {
