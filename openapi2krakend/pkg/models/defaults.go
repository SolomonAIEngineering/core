...
func DefaultEndpointExtraConfig(environment string) map[string]interface{} {
	if environment == "production" {
		return map[string]interface{}{
			...
			"auth/validator": map[string]interface{}{
				...
				"cache_duration":       3600,
				"alg":                  "RS256",
				"audience":             []string{"https://solomon-ai.us.auth0.com/api/v2/", "https://app-platform.solomon-ai.io", "https://production.solomon-ai.dev"},
	...
	return map[string]interface{}{
		...
		"auth/validator": map[string]interface{}{
			...
			"cache_duration":       3600,
			"alg":                  "RS256",
			"audience":             []string{"https://dev-26i1fsf2m1n6hqk1.us.auth0.com/api/v2/", "https://app-release.solomon-ai.io", "http://localhost:3000", "https://staging.solomon-ai.dev"},
